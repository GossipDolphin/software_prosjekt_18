...
public class OrganiserTest {
    ...
    private Arrangement arrangement = new Arrangement("KekLøpForAlle", LocalDateTime.parse(randomTid, formatter), LocalDateTime.parse(randomTid, formatter), "Halden", organiser, new ArrayList<>(), new ArrayList<>());
    ...
    public void opprett_arrangement() {
        ...
        assertEquals(organiser.opprettArrangement("KekLøpForAlle", LocalDateTime.parse(randomTid, formatter), LocalDateTime.parse(randomTid, formatter), "Halden", organiser, racelist, listeMedDeltagere).toString(), arrangement.toString());
    }
